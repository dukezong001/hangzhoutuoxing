...
#emsys
make zImage -j4
cp arch/arm/boot/zImage /mnt/windows/mfgtools-with-rootfs_nand_mao_four_gateway/mfgtools/Profiles/Linux/OS\ Firmware/files/IMX6ULL-IGW/8IGW/
make dtbs
cp arch/arm/boot/dts/b-imx6ull8IGW-gpmi-weim.dtb /mnt/windows/mfgtools-with-rootfs_nand_mao_four_gateway/mfgtools/Profiles/Linux/OS\ Firmware/files/IMX6ULL-IGW/8IGW/
#实际使用版本
