...
#define SIMCOM_SIM7600_PID 0x9011								 
/*
...
static const struct option_blacklist_info fibocom_ma510_mode30_blacklist = {
...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(0x05c6, 0x0106) }, /*mdm9205 9008e*/
	{ USB_DEVICE(0x05c6, 0x90b2) , /*MA510 USBMODE = 30*/.driver_info = (kernel_ulong_t)&fibocom_ma510_mode30_blacklist },
	{ USB_DEVICE(0x1782, 0x4d10) , /*L610 USBMODE = 31*/.driver_info = (kernel_ulong_t)&net_intf3_blacklist },
	{ USB_DEVICE(0x2cb7, 0x010a) , /*MA510 USBMODE = 32*/.driver_info = (kernel_ulong_t)&net_intf2_blacklist },
	{ USB_DEVICE(0x1508, 0x1001) , .driver_info = (kernel_ulong_t)&net_intf2_blacklist },
	//for SIM7600 modem for NDIS
...
#if 1 //Added by Quectel---cat1--jhf
//EC200S
...
//uc200t
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C)
	&& serial->dev->descriptor.idProduct == cpu_to_le16(0x6120)
	&& ((serial->interface->cur_altsetting->desc.bInterfaceNumber >= 5)
	||(serial->interface->cur_altsetting->desc.bInterfaceNumber <= 1))) {
		return -ENODEV;	
	}
	...
	if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C)) {
		...
		if ((idProduct != 0x6026 && idProduct != 0x6120) && serial->interface->cur_altsetting->desc.bInterfaceNumber >= 5)
			return -ENODEV;
	}
#endif
	 if (serial->dev->descriptor.idVendor == cpu_to_le16(0x2C7C)
		&& serial->dev->descriptor.idProduct != cpu_to_le16(0x6120) //exclude uc200t
		&& serial->dev->descriptor.idProduct != cpu_to_le16(0x6026) //exclude EC200T
		&& serial->interface->cur_altsetting->desc.bInterfaceNumber >= 5)	
	{
	...
	if (dev_desc->idVendor == cpu_to_le16(SAMSUNG_VENDOR_ID) &&
		...
		return -ENODEV;
#if 0 //Added by Quectel--------------cat4--jhf
//Quectel UC20's interface 4 can be used as USB network device
