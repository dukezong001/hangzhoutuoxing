...
#define CONFIG_MFG_NAND_PARTITION "mtdparts=gpmi-nand:4m(boot),16m(kernel),1m(dtb),1m(misc),-(rootfs) "
#else
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=console=ttymxc0,115200 ubi.mtd=4 "  \
		...
		CONFIG_BOOTARGS_CMA_SIZE \
		"mtdparts=gpmi-nand:4m(boot),16m(kernel),1m(dtb),1m(misc),-(rootfs)\0"\
	"bootcmd=nand read ${loadaddr} 0x400000 0x540000;"\
		"nand read ${fdt_addr} 0x1400000 0x10000;"\
